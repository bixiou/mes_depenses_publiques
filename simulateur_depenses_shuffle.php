...
-->
        ...
        <script type="text/javascript" src="simulateur_depenses_shuffle.js"></script> <!-- algo_av&des moy_actuel_utilitarien nivvie  -->
...
.axis line {
  ...
  shape-rendering: crispEdges;
    ...
    <div id="Text_deficit" style="left:700px; position:relative; vertical-align:top; float:left;"><span style="color:green">Équilibre</span><span style="color:red">&emsp;3% de déficit</span></div>
    <form><br><input type="checkbox" id="Fixed_total"> Bloquer la dépense totale au montant désiré</form><br>
    ...
    <div style="display:inline"><span id="Slider_recette_text">&emsp;Recettes  </span>
    ...
    <div id="Sliders"></div>
    <input type="button" name="Enregistrer" id="enregistrer" value="Enregistrer ma proposition !">
    <input type="button" name="Affiche_moyenne" id="affiche_moyenne" value="Affiche la moyenne des propositions">
